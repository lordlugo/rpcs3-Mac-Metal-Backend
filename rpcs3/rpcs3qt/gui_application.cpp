...
#ifdef __APPLE__
		if (!m_render_creator->Metal.supported)
		{
			QMessageBox::warning(nullptr,
									tr("Warning"),
									tr("Metal 4 is not supported on this Mac.\n"
...
std::unique_ptr<gs_frame> gui_application::get_gs_frame()
{
	...
	case video_renderer::metal: // Plain QWindow backed by a CAMetalLayer (see gs_frame constructor)
	{
